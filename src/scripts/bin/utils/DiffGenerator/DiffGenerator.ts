...
import { IDiffSchema } from '../../utils/DiffGenerator/IDiffSchema'
...
export class DiffGenerator {
	...
	private checkRecipeIngredient(
		originalIngredient: IItemAmountSchema | undefined,
		newIngredient: IItemAmountSchema | undefined,
		type: string
	): string | null {
		...
		if (originalIngredient.item !== newIngredient.item) {
			return (
				...
				' ' +
				this.newSchema.items[newIngredient.item].name
			)
